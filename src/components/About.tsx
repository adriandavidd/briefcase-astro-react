    ...
    <div className="bg-zinc-950 border-2 rounded-lg border-zinc-900 flex flex-col justify-center items-center my-20 mx-60">
      <div className="p-10">
        ...
        <p className="text-2xl font-medium text-white">
          ...
          html and evolved into a constant dedication to learning more and more,
          My self-taught approach has given me the versatility to quickly adapt
          to new challenges , technologies and tools
        </p>
      </div>
    </div>
  );
